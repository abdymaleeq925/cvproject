                ...
                <div className="about-me-banner__wrapper">
                    ...
                    <div className="about-me-banner__content">
                        <div className="about-me-banner__content-info">
                            ...
                            <p className="about-me-banner__content-info-text">I'm a JS Fullstack graduate. I'm currently looking for an opportunity to join a company where I can contribute my knowledge. If you're a looking for someone who is stress tolerant and willing to work, say hi!
                            <br/><br/>
                            Most recently, I graduated at ITC BootCamp in Almaty, Kazakhstan. Before that, I 
                            worked at mining industry as a HSE Engineer and shift boss in Kyrgyzstan and Kazakhstan respectively. I have a degree in mining engineering and studied in Istanbul, Turkey.
                            <br/><br/>
